        ...
        children: [
          ...
          Expanded(child: GridView.builder(
              ...
              gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount:2,
                  ...
                  mainAxisExtent: Res.height*0.29
              ),
                    ...
                    child: Padding(
                      ...
                      child:Column(
                        children: [
                          ...
                          Image.asset(homeList[index].image,height: Res.height*0.2,),
                          Text(homeList[index].label,style: TextStyle(height: Res.tinyFont*0.8,fontSize: Res.font,fontWeight: FontWeight.bold),)
                        ],
                      ),
                    )
                ),
